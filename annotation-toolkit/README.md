...
~~~bash
uv run python run.py --profile cozie-safety --mode blind
~~~
...
uv run python run.py \
  --mode blind \
  --limit 5 \
  --dataset cozie_safety_review_blind_smoke_v1
~~~
...
~~~bash
uv run python run.py --delete-dataset cozie_safety_review_blind_v1
~~~
...
~~~bash
uv run python run.py \
  --delete-dataset cozie_safety_review_blind_v1 \
  --yes
~~~
...
~~~bash
uv run python run.py \
  --progress-dataset cozie_safety_review_blind_smoke_v1
~~~
...
~~~bash
uv run python run.py \
  --export-dataset cozie_safety_review_blind_single_smoke_v1
~~~
